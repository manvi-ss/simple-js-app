...
let pokemonRepository = (function () {
  // wrapping the pokeonList inside of an IIFE (Immediately Invoked Function Expression)
    ...
    return fetch(apiUrl)
      ...
      .then(function (json) {
        json.results.forEach(function (item) {
          // loop each pokemon over name and url
          let pokemon = {
            name: item.name,
            detailsUrl: item.url,
          };
      ...
      .catch(function (e) {
        // in case browser do not support
        console.error(e);
      });
  }
